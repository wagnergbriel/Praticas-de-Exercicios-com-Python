...
if salariobruto <= 900.00:  # Salário Bruto até 900 (inclusive) - isento
    print(
        f"Seu salario bruto é de R${salariobruto:0.2f}, você está isento dos descontos."
    )

elif (
    salariobruto > 900.00 and salariobruto <= 1500.00
):  # Salário Bruto até 1500 (inclusive) - desconto de 5%
    ...
    salariobruto > 1500.00 and salariobruto <= 2500.00
):  # Salário Bruto até 2500 (inclusive) - desconto de 10%
    IR = salariobruto * 0.1
    INSS = salariobruto * 0.1
    FGTS = salariobruto * 0.11
